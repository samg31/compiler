...
assign_expr::assign_expr( ref_expr* r, expr* v )
	:m_reference( r ), m_new_value( v )
{	
}

ref_expr* assign_expr::get_reference() const
{
	return m_reference;
}

expr* assign_expr::get_value() const
{
	return m_new_value;
}

void assign_expr::accept( visitor& v )
{
	v.visit( this );
}
